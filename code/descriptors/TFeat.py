...
STATS_FNAME = 'descriptors/aux/stats.liberty.t7'
MODEL_FNAME = 'descriptors/aux/tfeat_liberty_margin_star.t7'
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print('Wrong input format. Try ./TFeat.py imgs/ref.png ref.TFEAT')
        sys.exit(1)
